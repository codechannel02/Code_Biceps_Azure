...
var managementURL = 'https://str1str1.blob.${environment().suffixes.storage}/test/diskmount.ps1'

var newdisk = [for (item,i) in newdataDisks : {
...
var driveletter = [for (item,i) in exdataDisks : {
   
  drvletter:item.driveletter
